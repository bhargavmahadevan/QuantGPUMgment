...
export const TOPOLOGY_PRESETS: TopologyPreset[] = [
  {
    ...
    baseLatencyMs: 1850,
    optLatencyMs: 925,
    latencyReductionPct: 50.0,
    baselineSpendCampaign: 73.51,
    optimizedSpendCampaign: 36.76,
    grossSavingsCampaign: 36.76,
    fee25Campaign: 9.19,
    clientNetSavingsCampaign: 27.57,
    baseDurationHours: 49.0,
    optDurationHours: 24.5,
  ...
  },
  {
    ...
    optimizedSpendCampaign: 635.78,
    grossSavingsCampaign: 635.78,
    fee25Campaign: 158.94,
    clientNetSavingsCampaign: 476.83,
    baseDurationHours: 127.2,
    optDurationHours: 63.6,
  ...
  },
  {
    ...
    optimizedSpendCampaign: 5086.26,
    grossSavingsCampaign: 5086.26,
    fee25Campaign: 1271.57,
    clientNetSavingsCampaign: 3814.70,
    baseDurationHours: 423.9,
    optDurationHours: 211.9,
  ...
  },
  {
    ...
    optimizedSpendCampaign: 6357.83,
    grossSavingsCampaign: 6357.83,
    fee25Campaign: 1589.46,
    clientNetSavingsCampaign: 4768.37,
    baseDurationHours: 397.4,
    optDurationHours: 198.7,
  ...
  },
  {
    ...
    optimizedSpendCampaign: 42279.52,
    grossSavingsCampaign: 42279.52,
    fee25Campaign: 10569.88,
    clientNetSavingsCampaign: 31709.64,
    baseDurationHours: 695.4,
    optDurationHours: 347.7,
    defaultCampaignsPerYear: 4,
  ...
  },
  {
    ...
    optimizedSpendCampaign: 158945.60,
    grossSavingsCampaign: 158945.60,
    fee25Campaign: 39736.40,
    clientNetSavingsCampaign: 119209.20,
    baseDurationHours: 1324.5,
    optDurationHours: 662.3,
  ...
  },
  {
    ...
    optimizedSpendCampaign: 534057.44,
    grossSavingsCampaign: 534057.44,
    fee25Campaign: 133514.36,
    clientNetSavingsCampaign: 400543.08,
    baseDurationHours: 1192.1,
    optDurationHours: 596.0,
    defaultCampaignsPerYear: 2,
  ...
  },
  {
    ...
    optimizedSpendCampaign: 1798502.01,
    grossSavingsCampaign: 1798502.01,
    fee25Campaign: 449625.50,
    clientNetSavingsCampaign: 1348876.51,
    baseDurationHours: 2066.3,
    optDurationHours: 1033.1,
  ...
  },
  {
    ...
    optimizedSpendCampaign: 2441404.42,
    grossSavingsCampaign: 2441404.42,
    fee25Campaign: 610351.10,
    clientNetSavingsCampaign: 1831053.31,
    baseDurationHours: 1490.1,
    optDurationHours: 745.1,
    defaultCampaignsPerYear: 1,
...
export default function GpuProfitCalculator() {
  ...
  const [customOptLatencyMs, setCustomOptLatencyMs] = useState<number>(2000);
